...
namespace EFDemo
{
    ...
    public partial class oms_open_vt_PurchaseReturnOrderItem
    {
        ...
        public Nullable<int> Pur_ExpectQuantity { get; set; }
        public Nullable<int> Pur_FactQuantity { get; set; }
        ...
        public Nullable<int> ExpectPackageQuantity { get; set; }
        public Nullable<System.Guid> BillOrderID { get; set; }
        public Nullable<int> FactPackageQuantity { get; set; }
